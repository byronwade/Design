...
export const contractProjects: ContractProject[] = [
  {
    ...
    files: [
      ...
      '.design/receipts/latest.json',
      'design/references/warm/',
    ],
    roles: ['Design owner', 'Frontend implementer', 'AI agent', 'Reviewer'],
    skills: [
      { name: 'design', path: '.agents/skills/design/SKILL.md', when: 'Before UI work', purpose: 'Resolve the task, apply the packet, check source, and verify evidence.' },
      ...
      { name: 'design-review', path: '.agents/skills/design-review/SKILL.md', when: 'Compatibility review', purpose: 'Router into the universal design verification receipt.' },
    ],
    photos: [
  ...
  },
  {
    ...
    skills: [
      { name: 'design', path: '.agents/skills/design/SKILL.md', when: 'Before UI work', purpose: 'Resolve target context, app type, mappings, and references.' },
  ...
  },
  {
    ...
    command: 'design init --profile web-app',
    prompt:
      'Create a visual reference starter contract. Do not download bulk photos by default. Keep media under design/references/ or a permissioned external source. Add only approved screenshots or product photos, summarize what to preserve in DESIGN.md, and require the AI to run the universal design Skill before UI changes.',
    files: ['DESIGN.md', '.agents/skills/design/SKILL.md', '.design/generated/TASK.json', 'design/references/starter/'],
    roles: ['Founder', 'Designer', 'AI agent'],
    skills: [
      { name: 'design', path: '.agents/skills/design/SKILL.md', when: 'Before UI work', purpose: 'Bind visual references to the resolved task packet.' },
    ...
    photos: [
      ...
      { label: 'Pattern notes', path: 'DESIGN.md#references', note: 'Mobbin-style tags without copied data.' },
    ],
    components: [
