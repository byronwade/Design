...
Status: superseded source summary. The accepted Warm Paper Workbench system remains normative; the Calm Paper Workbench preference reference preserves additional detail.
